...
### Wave 4 · 宣称对账与度量真化 ✅（2026-08-31 完成，2.2.0 发布）
...
四波全部闭合（1.5 个工作日）：Wave 1 安全兜底链（UAF/死锁/fail-open/
饿死/NaN）、Wave 2 防线（ASAN CI/-Werror/TSAN 手册）、Wave 3 信任链
（内容绑定/公钥钉住/install 排私钥）、Wave 4 宣称对账（README 四处/
真分母 86.7%/徽章置红/版本 2.2.0/toolkit）。测试 32→37 模块。
CI 五 job：secrets-scan / 双 RMW / asan-gate。
